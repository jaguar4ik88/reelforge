...
return [
    'auth' => [
        ...
        'registration_disabled' => 'New registrations are temporarily closed. Please sign in if you already have an account.',
    ],
    'project' => [
    ...
    'photo_guided' => [
        ...
        'video_blocked_low_credits' => 'Video generation requires at least :min credits in your balance.',
        'video_blocked_no_subscription' => 'Video generation requires an active subscription.',
        'video_blocked_starter_plan' => 'Video generation is not available on the Starter plan. Choose a higher plan.',
