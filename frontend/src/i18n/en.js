export default {
  translation: {
    ...
    templatesPage: {
      searchPlaceholder: 'Search by style or category',
      select:            'Select',
      filterBy:          'Filter by',
      reset:             'Reset',
      gridTitle:         '{{count}} ideas to explore',
      gridHint:          'Click a card to use as reference (coming soon)',
    ...
    photoFlow: {
      ...
      subtitle: 'Upload one product photo, then choose how it should look.',
      steps: {
